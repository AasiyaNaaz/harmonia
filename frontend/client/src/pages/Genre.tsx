...
const genreData = {
  pop: {
    ...
    artists: [
      { name: "Taylor Swift", bio: "Contemporary pop icon known for storytelling and genre evolution" },
      { name: "The Weeknd", bio: "R&B-influenced pop artist with distinctive vocal style" },
      { name: "Ariana Grande", bio: "Powerhouse vocalist blending pop and R&B influences" }
    ],
    instruments: [
  ...
  classical: {
    ...
    artists: [
      { name: "Ludwig van Beethoven", bio: "Revolutionary composer bridging Classical and Romantic eras" },
      { name: "Johann Sebastian Bach", bio: "Baroque master known for intricate counterpoint" },
      { name: "Wolfgang Amadeus Mozart", bio: "Prolific Classical period composer with timeless works" }
    ],
    instruments: [
  ...
  electronic: {
    ...
    artists: [
      { name: "Daft Punk", bio: "French duo pioneering electronic house music" },
      { name: "Deadmau5", bio: "Progressive house producer with technical mastery" },
      { name: "Skrillex", bio: "Dubstep innovator pushing sonic boundaries" }
    ],
    instruments: [
  ...
  qawwali: {
    ...
    artists: [
      { name: "Nusrat Fateh Ali Khan", bio: "Legendary voice bringing Qawwali to global audiences" },
      { name: "Rahat Fateh Ali Khan", bio: "Contemporary master continuing family legacy" },
      { name: "Sabri Brothers", bio: "Influential ensemble preserving traditional style" }
    ],
    instruments: [
  ...
  folk: {
    ...
    artists: [
      { name: "Bob Dylan", bio: "Singer-songwriter revolutionizing folk music" },
      { name: "Joan Baez", bio: "Powerful voice of social justice through folk" },
      { name: "Pete Seeger", bio: "Activist preserving American folk traditions" }
    ],
    instruments: [
